            ...
            <div className="">
                <div className=" relative flex flex-col items-center lg:h-72 lg:w-[22.5rem] md:w-[20rem] w-[18rem] bg-white border border-gray-200 rounded-lg shadow hover:shadow-xl duration-200 dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div className="flex flex-col p-4 leading-normal">
                        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white text-left">Green Revolution</h5>
                        <p className=" font-normal text-gray-700 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam, adipisci.</p>
                    </div>
                </div>
            </div>
