        ...
        <>
            ...
            >
                <SwiperSlide className=" shadow-xl">
                    <div className=" max-w-[600px] min-h-[300px] mx-auto md:grid grid-cols-5 sm:flex bg-white p-6 border-t-4 border-b-4 border-red-200 bg-gradient-to-tr from-red-50 via-white to-pink-50">
