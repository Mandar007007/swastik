...
>>>>>>> 6abca4a9d03217c6f2ab2c3872d76479a92252ac
  ...
  return (
    <>
      <button onClick={showComments} type="submit" className="text-white absolute end-[110px] bottom-[1.80rem] bg-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-700 font-medium rounded-sm text-xl p-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={onOpen} ><FaMessage /></button>
