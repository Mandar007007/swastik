                    ...
                    <div className=" max-w-[800px] max-h-[1100px] sm:mx-auto mx-5 bg-white shadow-xl py-8 sm:px-20 px-10 sm:grid sm:grid-cols-7 grid-cols-1 justify-center">
                        ...
                        <div className=" col-start-1 col-end-8">
                            <div className=" h-full flex items-center sm:justify-between justify-center">
                                ...
                                <div className="">
                                    <button type="button" className="text-white bg-gradient-to-br rounded-sm from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/80 font-medium text-sm px-4 py-2 text-center" onClick={() => { navigate('/otp') }}>
                                        Get OTP
                                    </button>
                                </div>
                            </div>
